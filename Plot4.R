...
#Read in only the relevant dates (2075260 rows -> 2880 rows). Note: The sep and header arguments are very important
...
#Create plot4_4
plot4_4 <- plot(my_data2[ 1], my_data2$Global_reactive_power, type="l", ylab = "Global_reactive_power", xlab = "datetime")
